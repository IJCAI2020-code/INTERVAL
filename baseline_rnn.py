...
class RNNDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        return torch.LongTensor(X), torch.LongTensor(Y), torch.LongTensor(lengths)-1
...
class MyModel(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser, root_dir):
        ...
        parser.add_argument('--only_rnn', default=True, action='store_true')
...
def run_test():
    ...
    # )
#    model = MyModel.load_from_metrics(
#        weights_path='saved/rnn/model_weights/inner/0/_ckpt_epoch_12.ckpt',
#        tags_csv='saved/rnn/test_tube_data/inner/version_0/meta_tags.csv',
#        on_gpu=True,
#        map_location=torch.device('cuda')
#    )
#    model = MyModel.load_from_metrics(
#        weights_path='saved/rnn/model_weights/nash/2/_ckpt_epoch_23.ckpt',
#        tags_csv='saved/rnn/test_tube_data/nash/version_2/meta_tags.csv',
#        on_gpu=True,
#        map_location=torch.device('cuda')
#    )
#    model = MyModel.load_from_metrics(
#        weights_path='saved/rnn/model_weights/nash/7/_ckpt_epoch_8.ckpt',
#        tags_csv='saved/rnn/test_tube_data/nash/version_7/meta_tags.csv',
#        on_gpu=True,
#        map_location=torch.device('cuda')
#    )
#    trainer = Trainer()
#    trainer.test(model)
#    model = MyModel.load_from_metrics(
#        weights_path='saved/rnn/model_weights/nash/8/_ckpt_epoch_8.ckpt',
#        tags_csv='saved/rnn/test_tube_data/nash/version_8/meta_tags.csv',
#        on_gpu=True,
#        map_location=torch.device('cuda')
#    )
#    trainer = Trainer()
#    trainer.test(model)
    model = MyModel.load_from_metrics(
        weights_path='saved_seed1/rnn/model_weights/ad/0/_ckpt_epoch_10.ckpt',
        tags_csv='saved_seed1/rnn/test_tube_data/ad/version_0/meta_tags.csv',
        on_gpu=True,
        map_location=torch.device('cuda')
    )
    trainer = Trainer()
